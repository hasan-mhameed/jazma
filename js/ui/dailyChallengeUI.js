...
import { getDailyConfig, difficultyName, hasPlayedToday,
         saveDailyResult, getDailyLeaderboard, todayStr } from "../dailyChallenge.js?v=1781646753";
import { config }      from "../config/config.js?v=1781646753";
import { AIPlayer }    from "../ai/aiPlayer.js?v=1781646753";
import { addXP, calcXP } from "../xp.js?v=1781646753";
...
function gridLabel(size) {
  const sq = size - 1; // 4 نقاط = 3×3 مربعات
  return `${sq}×${sq} مربعات`;
}
