...
import { getDailyConfig, difficultyName, hasPlayedToday,
         saveDailyResult, getDailyLeaderboard, todayStr } from "../dailyChallenge.js?v=1780524300";
import { config }      from "../config/config.js?v=1780524300";
import { AIPlayer }    from "../ai/aiPlayer.js?v=1780524300";
import { addXP, calcXP } from "../xp.js?v=1780524300";
import { showXPGain }  from "./xpUI.js?v=1780524300";
import { getCurrentUser } from "../auth.js?v=1780524300";
