...
import { getDailyConfig, difficultyName, hasPlayedToday,
         saveDailyResult, getDailyLeaderboard, todayStr } from "../dailyChallenge.js?v=1783805737";
import { config }      from "../config/config.js?v=1783805737";
import { AIPlayer }    from "../ai/aiPlayer.js?v=1783805737";
import { addXP, calcXP } from "../xp.js?v=1783805737";
