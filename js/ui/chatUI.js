...
import { sendMessage, listenMessages, listenUnread, markAsRead, markDelivered, markRead } from "../chat.js?v=1782519228";
import { getCurrentUser } from "../auth.js?v=1782519228";
import { audioManager } from "../audio/audioManager.js?v=1782519228";
import { playNotifSound } from "../audio/notif.js?v=1782519228";
...
export function openChat(friend) {
  ...
  // مسح الـ unread badge — نستخدم custom event بدل dynamic import
  document.dispatchEvent(new CustomEvent('chat:opened', { detail: friend.uid }));
