...
import { POWERS, getInventory } from "../core/powers.js?v=1787005544";
import { state } from "../core/state.js?v=1787005544";
import { getPowerIcon } from "./powerIcons.js?v=1787005544";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1787005544').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
