...
import { POWERS, getInventory } from "../core/powers.js?v=1783755247";
import { state } from "../core/state.js?v=1783755247";
import { getPowerIcon } from "./powerIcons.js?v=1783755247";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1783755247').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
