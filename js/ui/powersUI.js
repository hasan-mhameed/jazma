...
import { POWERS, getInventory } from "../core/powers.js?v=1789078595";
import { state } from "../core/state.js?v=1789078595";
import { getPowerIcon } from "./powerIcons.js?v=1789078595";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789078595').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
