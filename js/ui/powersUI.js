...
import { POWERS, getInventory } from "../core/powers.js?v=1783792812";
import { state } from "../core/state.js?v=1783792812";
import { getPowerIcon } from "./powerIcons.js?v=1783792812";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1783792812').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
