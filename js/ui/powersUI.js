...
import { POWERS, getInventory } from "../core/powers.js?v=1789325132";
import { state } from "../core/state.js?v=1789325132";
import { getPowerIcon } from "./powerIcons.js?v=1789325132";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789325132').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
