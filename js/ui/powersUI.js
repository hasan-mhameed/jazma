...
import { POWERS, getInventory } from "../core/powers.js?v=1789825144";
import { state } from "../core/state.js?v=1789825144";
import { getPowerIcon } from "./powerIcons.js?v=1789825144";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789825144').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
