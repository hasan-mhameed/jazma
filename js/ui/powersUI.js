...
import { POWERS, getInventory } from "../core/powers.js?v=1782602707";
import { state } from "../core/state.js?v=1782602707";
import { getPowerIcon } from "./powerIcons.js?v=1782602707";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1782602707').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
