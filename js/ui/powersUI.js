...
import { POWERS, getInventory } from "../core/powers.js?v=1789834031";
import { state } from "../core/state.js?v=1789834031";
import { getPowerIcon } from "./powerIcons.js?v=1789834031";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789834031').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
