...
import { POWERS, getInventory } from "../core/powers.js?v=1784361079";
import { state } from "../core/state.js?v=1784361079";
import { getPowerIcon } from "./powerIcons.js?v=1784361079";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1784361079').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
