...
import { POWERS, getInventory } from "../core/powers.js?v=1789215947";
import { state } from "../core/state.js?v=1789215947";
import { getPowerIcon } from "./powerIcons.js?v=1789215947";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789215947').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
