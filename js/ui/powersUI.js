...
import { POWERS, getInventory } from "../core/powers.js?v=1789328750";
import { state } from "../core/state.js?v=1789328750";
import { getPowerIcon } from "./powerIcons.js?v=1789328750";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789328750').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
