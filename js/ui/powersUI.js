...
import { POWERS, getInventory } from "../core/powers.js?v=1788733802";
import { state } from "../core/state.js?v=1788733802";
import { getPowerIcon } from "./powerIcons.js?v=1788733802";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1788733802').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
