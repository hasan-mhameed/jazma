...
import { POWERS, getInventory } from "../core/powers.js?v=1783896061";
import { state } from "../core/state.js?v=1783896061";
import { getPowerIcon } from "./powerIcons.js?v=1783896061";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1783896061').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
