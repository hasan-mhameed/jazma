...
import { POWERS, getInventory } from "../core/powers.js?v=1785103705";
import { state } from "../core/state.js?v=1785103705";
import { getPowerIcon } from "./powerIcons.js?v=1785103705";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1785103705').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
