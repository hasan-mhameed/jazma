...
import { POWERS, getInventory } from "../core/powers.js?v=1784757639";
import { state } from "../core/state.js?v=1784757639";
import { getPowerIcon } from "./powerIcons.js?v=1784757639";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1784757639').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
