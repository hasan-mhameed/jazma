...
import { POWERS, getInventory } from "../core/powers.js?v=1787484560";
import { state } from "../core/state.js?v=1787484560";
import { getPowerIcon } from "./powerIcons.js?v=1787484560";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1787484560').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
