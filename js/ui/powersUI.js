...
import { POWERS, getInventory } from "../core/powers.js?v=1789238706";
import { state } from "../core/state.js?v=1789238706";
import { getPowerIcon } from "./powerIcons.js?v=1789238706";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789238706').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
