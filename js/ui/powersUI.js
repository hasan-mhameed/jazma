...
import { POWERS, getInventory } from "../core/powers.js?v=1785540675";
import { state } from "../core/state.js?v=1785540675";
import { getPowerIcon } from "./powerIcons.js?v=1785540675";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1785540675').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
