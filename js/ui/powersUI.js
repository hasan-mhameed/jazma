...
import { POWERS, getInventory } from "../core/powers.js?v=1784404579";
import { state } from "../core/state.js?v=1784404579";
import { getPowerIcon } from "./powerIcons.js?v=1784404579";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1784404579').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
