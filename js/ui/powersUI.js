...
import { POWERS, getInventory } from "../core/powers.js?v=1785794447";
import { state } from "../core/state.js?v=1785794447";
import { getPowerIcon } from "./powerIcons.js?v=1785794447";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1785794447').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
