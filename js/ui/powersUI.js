...
import { POWERS, getInventory } from "../core/powers.js?v=1790013057";
import { state } from "../core/state.js?v=1790013057";
import { getPowerIcon } from "./powerIcons.js?v=1790013057";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1790013057').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
