...
import { POWERS, getInventory } from "../core/powers.js?v=1787485449";
import { state } from "../core/state.js?v=1787485449";
import { getPowerIcon } from "./powerIcons.js?v=1787485449";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1787485449').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
