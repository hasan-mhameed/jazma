...
import { POWERS, getInventory } from "../core/powers.js?v=1784503058";
import { state } from "../core/state.js?v=1784503058";
import { getPowerIcon } from "./powerIcons.js?v=1784503058";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1784503058').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
