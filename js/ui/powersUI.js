...
import { POWERS, getInventory } from "../core/powers.js?v=1788215397";
import { state } from "../core/state.js?v=1788215397";
import { getPowerIcon } from "./powerIcons.js?v=1788215397";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1788215397').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
