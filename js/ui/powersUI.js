...
import { POWERS, getInventory } from "../core/powers.js?v=1787498297";
import { state } from "../core/state.js?v=1787498297";
import { getPowerIcon } from "./powerIcons.js?v=1787498297";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1787498297').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
