...
import { POWERS, getInventory } from "../core/powers.js?v=1789932693";
import { state } from "../core/state.js?v=1789932693";
import { getPowerIcon } from "./powerIcons.js?v=1789932693";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789932693').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
