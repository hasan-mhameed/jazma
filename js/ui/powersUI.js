...
import { POWERS, getInventory } from "../core/powers.js?v=1788647139";
import { state } from "../core/state.js?v=1788647139";
import { getPowerIcon } from "./powerIcons.js?v=1788647139";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1788647139').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
