...
import { POWERS, getInventory } from "../core/powers.js?v=1784589600";
import { state } from "../core/state.js?v=1784589600";
import { getPowerIcon } from "./powerIcons.js?v=1784589600";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1784589600').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
