...
import { POWERS, getInventory } from "../core/powers.js?v=1782829249";
import { state } from "../core/state.js?v=1782829249";
import { getPowerIcon } from "./powerIcons.js?v=1782829249";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1782829249').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
