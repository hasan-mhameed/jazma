...
import { POWERS, getInventory } from "../core/powers.js?v=1786382003";
import { state } from "../core/state.js?v=1786382003";
import { getPowerIcon } from "./powerIcons.js?v=1786382003";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1786382003').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
