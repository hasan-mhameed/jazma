...
import { POWERS, getInventory } from "../core/powers.js?v=1789830197";
import { state } from "../core/state.js?v=1789830197";
import { getPowerIcon } from "./powerIcons.js?v=1789830197";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1789830197').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
