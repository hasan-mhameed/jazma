...
import { POWERS, getInventory } from "../core/powers.js?v=1785770097";
import { state } from "../core/state.js?v=1785770097";
import { getPowerIcon } from "./powerIcons.js?v=1785770097";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1785770097').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
