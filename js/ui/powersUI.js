...
import { POWERS, getInventory } from "../core/powers.js?v=1785711246";
import { state } from "../core/state.js?v=1785711246";
import { getPowerIcon } from "./powerIcons.js?v=1785711246";
...
function addGuideButton(bar) {
  ...
  btn.addEventListener('click', () => {
    import('./guideUI.js?v=1785711246').then(m => m.openGuide());
  });
  bar.appendChild(btn);
}
