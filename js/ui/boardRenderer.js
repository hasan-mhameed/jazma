...
import { makeKey }                            from "../utils.js?v=1789831815";
import { renderScoreboard, updateScoreboard } from "./scoreboard.js?v=1789831815";
import { updateTurn, updateTurnUI }           from "./turnManager.js?v=1789831815";
import { endGame }                            from "./gameEnd.js?v=1789831815";
import { audioManager }                       from "../audio/audioManager.js?v=1789831815";
import { checkSquaresAround }                 from "../core/logic.js?v=1789831815";
import { onlineManager }                      from "../firebase.js?v=1789831815";
import { generateSpecialSquares, getElementAt, ELEMENTS, setElementMap, getElementMap } from "../core/specialSquares.js?v=1789831815";
import { resetPowers, addPower, getEffect, clearEffect, consumePower, setEffect, hasPower } from "../core/powers.js?v=1789831815";
import { refreshInventory } from "./powersUI.js?v=1789831815";
import { maybeShowTutorial } from "./powerTutorial.js?v=1789831815";
import { isTimerEnabled, startTurnTimer, stopTurnTimer, cutBank, getTimerMode, getBank, setBank } from "./turnTimer.js?v=1789831815";
import { resetMatchCoins, addMatchCoins } from "../core/wallet.js?v=1789831815";
