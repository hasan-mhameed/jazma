...
import { startBoard, updateScoreboard, resetState } from "./board.js?v=1788217348";
import { updateTurnUI }                        from "./ui/turnManager.js?v=1788217348";
import { audioManager }                        from "./audio/audioManager.js?v=1788217348";
import { onlineManager, cleanupOldRooms } from "./firebase.js?v=1788217348";
import { onUserChange, getCurrentUser, getAllStats, isGuest } from "./auth.js?v=1788217348";

import { initAuthUI, initGuestUI }  from "./ui/authUI.js?v=1788217348";
import { initGameSetup }       from "./ui/gameSetup.js?v=1788217348";
import { initTurnTimer, stopTurnTimer, startTurnTimer, TIME_BANKS, enableCentralClock, applyClockState } from "./ui/turnTimer.js?v=1788217348";
import { initOnlineGame, launchOnlineGame, updateOnlineTurnIndicator } from "./ui/onlineGame.js?v=1788217348";
import { initFriendsUI }       from "./ui/friendsUI.js?v=1788217348";
import { initLeaderboardUI }   from "./ui/leaderboardUI.js?v=1788217348";
import { initInviteListener, sendInviteGame, showRejectionAlert } from "./ui/inviteUI.js?v=1788217348";
import { initChatUI, openChat, initChatNotifications } from "./ui/chatUI.js?v=1788217348";
import { initMessagesUI, clearUnreadFor }              from "./ui/messagesUI.js?v=1788217348";
import { renderStatsModal }    from "./ui/statsModal.js?v=1788217348";
import { initHistoryUI }       from "./ui/historyUI.js?v=1788217348";
import { resetMatchTimer, endGame } from "./ui/gameEnd.js?v=1788217348";
import { initAchievementsUI }  from "./ui/achievementsUI.js?v=1788217348";
import { initXPUI, refreshXPBar } from "./ui/xpUI.js?v=1788217348";
import { refreshCoinsBadge } from "./core/wallet.js?v=1788217348";
import { loadLearnedPowers } from "./ui/powerTutorial.js?v=1788217348";
import { initPowersUI, refreshInventory } from "./ui/powersUI.js?v=1788217348";
import { POWERS, addPower } from "./core/powers.js?v=1788217348";
import { spendCoins } from "./core/wallet.js?v=1788217348";
import { extendTime, cutBank, getTimerMode, getBank } from "./ui/turnTimer.js?v=1788217348";
import { activatePower, triggerAI, nextActivePlayer } from "./ui/boardRenderer.js?v=1788217348";
import { initNavMenu }            from "./ui/navMenu.js?v=1788217348";
import { initDailyChallengeUI }  from "./ui/dailyChallengeUI.js?v=1788217348";
