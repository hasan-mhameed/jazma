...
import { config }                              from "./config/config.js?v=1783551240";
import { state }                               from "./core/state.js?v=1783551240";
import { startBoard, updateScoreboard, resetState } from "./board.js?v=1783551240";
import { updateTurnUI }                        from "./ui/turnManager.js?v=1783551240";
import { audioManager }                        from "./audio/audioManager.js?v=1783551240";
import { onlineManager, cleanupOldRooms } from "./firebase.js?v=1783551240";
import { onUserChange, getCurrentUser, getAllStats, isGuest } from "./auth.js?v=1783551240";

import { initAuthUI, initGuestUI }  from "./ui/authUI.js?v=1783551240";
import { initGameSetup }       from "./ui/gameSetup.js?v=1783551240";
import { initTurnTimer, stopTurnTimer, startTurnTimer } from "./ui/turnTimer.js?v=1783551240";
import { initOnlineGame, launchOnlineGame, updateOnlineTurnIndicator } from "./ui/onlineGame.js?v=1783551240";
import { initFriendsUI }       from "./ui/friendsUI.js?v=1783551240";
import { initLeaderboardUI }   from "./ui/leaderboardUI.js?v=1783551240";
import { initInviteListener, sendInviteGame, showRejectionAlert } from "./ui/inviteUI.js?v=1783551240";
import { initChatUI, openChat, initChatNotifications } from "./ui/chatUI.js?v=1783551240";
import { initMessagesUI, clearUnreadFor }              from "./ui/messagesUI.js?v=1783551240";
import { renderStatsModal }    from "./ui/statsModal.js?v=1783551240";
import { initHistoryUI }       from "./ui/historyUI.js?v=1783551240";
import { resetMatchTimer }     from "./ui/gameEnd.js?v=1783551240";
import { initAchievementsUI }  from "./ui/achievementsUI.js?v=1783551240";
import { initXPUI, refreshXPBar } from "./ui/xpUI.js?v=1783551240";
import { refreshCoinsBadge } from "./core/wallet.js?v=1783551240";
import { loadLearnedPowers } from "./ui/powerTutorial.js?v=1783551240";
import { initPowersUI, refreshInventory } from "./ui/powersUI.js?v=1783551240";
import { POWERS, addPower } from "./core/powers.js?v=1783551240";
import { spendCoins } from "./core/wallet.js?v=1783551240";
import { extendTime } from "./ui/turnTimer.js?v=1783551240";
import { activatePower, triggerAI } from "./ui/boardRenderer.js?v=1783551240";
import { initNavMenu }            from "./ui/navMenu.js?v=1783551240";
import { initDailyChallengeUI }  from "./ui/dailyChallengeUI.js?v=1783551240";
