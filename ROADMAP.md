<!-- نسخة احتياطية من المستند الحيّ "خطة جزم للمرحلة القادمة"
     ...
     يُعاد توليد هذا الملف مع كل دفعة. آخر مزامنة: 2026-09-21 (v35.5) -->

# خطة جزم للمرحلة القادمة

**آخر مزامنة مع المستند: 2026-09-21 (v35.5)** · نسخة احتياطية — المستند الحيّ هو الأصل
...
الإصدار v35.5 جاهز للرفع، وفيه الخطوتان 1.4 و1.5. والخطوتان 1.1 و1.2 منجزتان، ثبّتتهما فحوصك على v35.4.
...
- المحاكي متعدد اللاعبين (tests/sim): 19 سيناريو، و3 مستكشفات عشوائية، وفحوص نافذة نهاية المباراة.
...
| 1.3 انضمام ثنائي محمي | لاعبان يبحثان بنفس اللحظة يدخلان على نفس المنتظر، والإلغاء لحظة الانضمام يترك غرفة فارغة ويسحب المُلغي لمباراة | متوسطة | المحاكي: يغطيها كلها (صعبة يدوياً). أنت: جولة ثنائي عادية فقط | لاحقاً |
| 1.4 نص زر البدء بالغرفة بالكود | العدد المختار حدّ أقصى لا شرط (قرارك بعد فحص v35.4). الزر يقول "ابدأ بلاعبَين (من 3)" بعدد ناقص، و"ابدأ المباراة" مع "اكتمل العدد" عند الاكتمال | منخفضة | المحاكي: نص الزر والجملة تحته بالحالتين. أنت: نظرة على النص | جاهز للرفع |
| 1.5 نافذة نهاية المباراة: الغائب وإحصائياتك | كشفها فحصاك 3 و4: المقعد الفارغ ظهر في النتيجة باسم "لاعب 1" برصيد 0، وإحصائيات كل الأجهزة كانت تُحسب للمقعد 1. ومعها: المشاهد تُسجَّل عليه خسارة ويكسب جواهر المقعد 1، وشارة المستوى على بطاقة غير صاحبها. الحل: النتيجة من مصدر واحد (من لعب فعلاً + مقعدك أنت) | منخفضة | المحاكي: فحوص جديدة لنافذة النهاية (37 تأكيداً، وعلى v35.4 تعيد الخلل حرفياً). أنت: غرفة غادرها منشئها قبل البدء، ومباراة جماعية يفوز فيها غير المقعد 1 | جاهز للرفع |
| 1.6 تسجيل نهايات الانسحاب | الفوز بانسحاب الخصوم يعرض رسالة فقط: لا فوز يُسجَّل ولا خبرة، وعملات الجواهر من المباراة تضيع. والمنسحب بالزر لا تُسجَّل عليه خسارة. الحل: كل النهايات تمرّ على نافذة النتيجة | متوسطة | المحاكي: توسعة فحوص نافذة النهاية لتشمل الانسحاب. أنت: انسحاب بالثنائي وبالجماعي | التالي |
...
| 3.2 أداء البحث | كل بحث (ثنائي وجماعي) يقرأ كل الغرف بما فيها سجلات حركات المباريات، فيبطؤ ويكلف مع الكثرة. الحل: فهرس خفيف للغرف المفتوحة | متوسطة | المحاكي: نعم. أنت: جولة عامة | بانتظار قرارك |
...
| الشبكة الحقيقية: بطء، انقطاع، مهلة السماح | جزئياً (إغلاق تبويب فقط) | نعم |
| داخل المباراة: اللوحة، الأدوار، الساعة، الأدوات، النقاط، النهاية | جزئياً: نافذة النهاية (الترتيب وما يُسجَّل) منذ v35.5. اللوحة والأدوار والساعة لا | نعم |
